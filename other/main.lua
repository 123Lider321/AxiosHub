...
local Button = PlayersTab:CreateButton({
    ...
    Interact = 'Execute',
    Callback = function()
        loadstring(game:HttpGet('https://raw.githubusercontent.com/123Lider321/AxiosHub/main/Scripts/fly-script.lua'))()
    end,
})
local Button = PlayersTab:CreateButton({
    Name = "NoClip",
...
local Button = HubsGuisTab:CreateButton({
    ...
    Interact = 'Execute',
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/123Lider321/AxiosHub/main/Scripts/feaudio.lua"))()
    end,
})
local Button = HubsGuisTab:CreateButton({
    Name = "Ice Hub",
...
local Button = HubsGuisTab:CreateButton({
    ...
    SectionParent = WorkinallgamesSection,
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/123Lider321/AxiosHub/main/Scripts/rice-antiafk.lua"))()
    end,
})
local Button = HubsGuisTab:CreateButton({
